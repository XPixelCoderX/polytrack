...
(function() {
    ...
    function getOutlineColors() {
        try {
            const theme = window._uiTheme && window._uiTheme.getTheme();
            const themes = window._uiTheme && window._uiTheme.THEMES;
            let btnHover = '#334b77'; 
            if (theme && theme.hue != null) {
                
                const base = themes && themes.blue;
                if (base) btnHover = base.btnHover; 
            } else if (theme && themes && themes[theme.preset]) {
                btnHover = themes[theme.preset].btnHover;
            }
            
            document.documentElement.style.setProperty('--editor-outline-color', btnHover);
            
            const outlineInt = hexStrToInt(btnHover);
            return {
                valid:    outlineInt,   
                overlap:  Math.round(outlineInt * 0.7), 
                invalid:  0xBBBB00,     
                deleteOk: 0xBB2222,     
                deleteBad:0xBB0000,     
            };
        } catch(e) {
            return { valid: 0x0000BB, overlap: 0x00BBBB, invalid: 0xBBBB00, deleteOk: 0xBB2222, deleteBad: 0xBB0000 };
        }
    }
    window._editorOutlineColors = getOutlineColors;
    
    const _origApply = document.documentElement.style.setProperty.bind(document.documentElement.style);
    ...
    CSSStyleDeclaration.prototype.setProperty = function(prop, val, priority) {
        origSet.call(this, prop, val, priority);
        if (prop === '--button-hover-color') {
            origSet.call(this, '--editor-outline-color', val, priority);
        }
    };
})();
    ...
    4124: (t, e, n) => {
        ...
        const TrackSettingsUI = class {
            constructor(t, e, n, s, o, a, r, h) {
                ...
                _snapLabel.append(document.createTextNode("Ghost snapshot interval (frames): "));
                ...
                _snapInput.max = "60",
                _snapInput.step = "1",
                _snapInput.value = String(isNaN(_snapVal) ? 15 : Math.max(3, _snapVal)),
            ...
            if (get(this, editor_isCopyMode, "f") || get(this, editor_isCutMode, "f")) {
                ...
                if (null != t) {
                    ...
                    if (get(this, editor_isCopyMode, "f"))
                        ...
                        p = 16776960,
                        u = window._editorOutlineColors().overlap
                    }
        ...
        const TrackEditor = class {
            constructor(t, e, n, s, o, a, r, h, l, c, d, g, f, p) {
                ...
                window.addEventListener("keydown", set(this, editor_onKeyDown, (t => {
                    ...
                    t.preventDefault()),
                    f.checkKeyBinding(t, KeyBind.EditorClearTrail) && ((() => {
                        ...
                        if (this.__editorTrailClearBtn) {
                            this.__editorTrailClearBtn.remove();
            ...
            enable() {
                ...
                (() => {
                    ...
                    if (!data || data.points.length < 6) return;
                ...
                get(this, editor_isActive, "f")) {
                    ...
                    if (null != t && null != get(this, editor_activePlacement, "f")) {
                        if (null == get(this, editor_lastOverlapCheckPos, "f") || get(this, editor_lastOverlapCheckPos, "f").x != t.x || get(this, editor_lastOverlapCheckPos, "f").y != t.y || get(this, editor_lastOverlapCheckPos, "f").z != t.z) {
                            ...
                            e ? (get(this, editor_ghostMaterial, "f").color.set(window._editorOutlineColors().invalid),
                            get(this, editor_tileIndicatorMaterial, "f").color.set(window._editorOutlineColors().invalid)) : (get(this, editor_ghostMaterial, "f").color.set(window._editorOutlineColors().valid),
                            get(this, editor_tileIndicatorMaterial, "f").color.set(window._editorOutlineColors().valid))
                        }
                        ...
                        if (null == e.id || get(this, editor_isDeleteKeyHeld, "f"))
                            n.length > 0 ? (get(this, editor_ghostMaterial, "f").color.set(window._editorOutlineColors().deleteBad),
                            get(this, editor_tileIndicatorMaterial, "f").color.set(window._editorOutlineColors().deleteBad)) : (get(this, editor_ghostMaterial, "f").color.set(window._editorOutlineColors().deleteOk),
                            get(this, editor_tileIndicatorMaterial, "f").color.set(window._editorOutlineColors().deleteOk));
                        else {
                            let s, o;
                            if (get(this, editor_isDeleteMode, "f"))
                            ...
                            s ? (get(this, editor_ghostMaterial, "f").color.set(window._editorOutlineColors().invalid),
                            get(this, editor_tileIndicatorMaterial, "f").color.set(window._editorOutlineColors().invalid)) : o ? (get(this, editor_ghostMaterial, "f").color.set(window._editorOutlineColors().overlap),
                            get(this, editor_tileIndicatorMaterial, "f").color.set(window._editorOutlineColors().overlap)) : (get(this, editor_ghostMaterial, "f").color.set(window._editorOutlineColors().valid),
                            get(this, editor_tileIndicatorMaterial, "f").color.set(window._editorOutlineColors().valid))
                        }
                        const s = []
                          , o = [];
